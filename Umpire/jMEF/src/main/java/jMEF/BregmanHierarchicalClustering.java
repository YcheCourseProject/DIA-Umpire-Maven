...
public class BregmanHierarchicalClustering {
     ...
     */
    public static HierarchicalMixtureModel build(MixtureModel f, CLUSTERING_TYPE type, LINKAGE_CRITERION linkage) {
     ...
     */
    private static int[] find2ClosestMixtureModels(HierarchicalMixtureModel[] hmmArray, CLUSTERING_TYPE type, LINKAGE_CRITERION linkage) {
     ...
     */
    private static double computeMinDistance(MixtureModel mm1, MixtureModel mm2, CLUSTERING_TYPE type) {
        double d = Double.MAX_VALUE;
     ...
     */
    private static double computeMaxDistance(MixtureModel mm1, MixtureModel mm2, CLUSTERING_TYPE type) {
        double d = 0;
        for (int i = 0; i < mm1.size; i++) {
            for (int j = 0; j < mm2.size; j++) {
                double tmp = 0;
     ...
     */
    private static double computeAverageDistance(MixtureModel mm1, MixtureModel mm2, CLUSTERING_TYPE type) {
        double d = 0;
        for (int i = 0; i < mm1.size; i++) {
            for (int j = 0; j < mm2.size; j++) {
                double tmp = 0;
