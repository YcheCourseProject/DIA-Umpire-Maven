...
public class BregmanHardClustering {
     ...
     */
    public static MixtureModel simplify(MixtureModel f, int m, CLUSTERING_TYPE type, int iterations) {
     ...
     * @return simplified mixture model g of m components
     */
    public static MixtureModel simplify(MixtureModel f, int m, CLUSTERING_TYPE type) {
     ...
     * @return simplified mixture model g of m components
     */
    public static MixtureModel simplify(MixtureModel f, MixtureModel g, CLUSTERING_TYPE type) {
     ...
     * @return initialization of the simplified mixture model
     */
    private static MixtureModel initialize(MixtureModel f, int m, CLUSTERING_TYPE type) {
     ...
     */
    private static void batchKMeans(MixtureModel f, MixtureModel g, CLUSTERING_TYPE type, int[] repartition) {
     ...
     * false otherwise
     */
    private static boolean incrementalKMeans(MixtureModel f, MixtureModel g, CLUSTERING_TYPE type, int[] repartition) {
        boolean cond = false;
        int iterations = 0;
     ...
     * @param repartition array of repartition
     */
    private static void computeRepartition(MixtureModel f, MixtureModel g, CLUSTERING_TYPE type, int[] repartition) {
        int n = f.size;
        int m = g.size;
     ...
     * @param repartition array of repartition
     */
    private static void computeCentroids(MixtureModel f, MixtureModel g, CLUSTERING_TYPE type, int[] repartition) {
        int n = f.size;
        int m = g.size;
        int i, j;
     ...
     */
    private static double getLossFunction(MixtureModel f, MixtureModel g, CLUSTERING_TYPE type) {
        int n = f.size;
        int m = g.size;
        double value = 0;
        for (int i = 0; i < n; i++) {
