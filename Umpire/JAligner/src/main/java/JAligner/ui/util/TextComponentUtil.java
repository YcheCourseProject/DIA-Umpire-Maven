    ...
    public static void print(JTextComponent textComponent)
        ...
        try {
            ...
            if (printServices.length > 0) {
                ...
                printRequestAttributeSet.add(new JobName("JAligner/src/main/java/JAligner", null));
                ...
                if (service != null) {
                    ...
                    DocumentName documentName = new DocumentName("JAligner/src/main/java/JAligner",
                            null);
